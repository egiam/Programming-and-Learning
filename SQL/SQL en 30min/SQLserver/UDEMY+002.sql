...
--SELECT * FROM ALL_CATALOG WHERE OWNER = 'PRUEBA' AND TABLE_TYPE = 'TABLE';
--SELECT * FROM ALL_ALL_TABLES WHERE OWNER = 'PRUEBA';
--SELECT * FROM PRODUCT_COMPONENT_VERSION;
--SELECT * FROM ALL_OBJECTS WHERE OWNER = 'PRUEBA';
--SELECT * FROM ALL_ALL_TABLES WHERE UPPER(TABLE_NAME) LIKE '%CLIE%';
--SELECT * FROM ALL_TAB_COLUMNS WHERE OWNER = 'PRUEBA' AND COLUMN_NAME LIKE '%CD_CLIENTE%';
